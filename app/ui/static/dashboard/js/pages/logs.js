...
Router.register('logs', {
  ...
  render: function () {
    return (
      ...
      '    <button class="btn btn-sm btn-ghost">Limpar Filtros</button>' +
      '  </div>' +
      '</div>' +
      '<div class="card">' +
      '  <div class="card-header">' +
      '    <span class="card-title">Eventos de Log</span>' +
      '    <select class="settings-input"><option>Todos os n\u00edveis</option><option>INFO</option><option>WARNING</option><option>ERROR</option></select>' +
      '  </div>' +
